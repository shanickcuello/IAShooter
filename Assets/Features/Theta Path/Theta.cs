...
public class Theta<T>
{
    ...
    public delegate T ClosestNode(Vector3 pos, T node, T currentClosest);
    public List<T> Run(T start, Satisfies satisfies, GetNeighbours getNeighbours, GetCost getcost, Heuristic heuristic, InSight inSight, int watchDong = 1000)
    {
